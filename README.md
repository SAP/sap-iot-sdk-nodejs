...
Hint: The implementation of @sap/xssec expects, that an [uaa configuration](./MIGRATION-GUIDE111) defines at least one role-template to process an successful token exchange.
