 ...
 * Next this configuration is used to instantiate a single thing,
 * which now can be used for further operations like data ingestion of time series read.
 *
 * After successful operation of the mentioned steps,
 * the cleanup will remove all created definitions so the script can be executed multiple times without manual cleanup.
