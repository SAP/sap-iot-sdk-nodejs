...
const debug = require('debug')('SAPIoT');
...
/**
 * Class acting as a SAP IoT client
 *
 * @class LeonardoIoT
...
class LeonardoIoT {
  /**
   * Creates a SAP IoT client
   *
   * @param {string|object} [configuration] - Either name of service which contains your SAP IoT service key or authentication and endpoint configuration
  ...
  /**
   * Sends a http request to SAP IoT
   *
