...
class LeonardoIoT {
   ...
   */
  async request({
    url, method = 'GET', headers = {}, body = {}, agentOptions = {}, resolveWithFullResponse = false, jwt, scopes,
  } = {}) {
   ...
   * @param {Array.string} scopes - List of scopes that should be fetched for the token
