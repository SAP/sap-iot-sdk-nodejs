...
class Authenticator {
   ...
   *
   * @param {Array.<string>} scopes Scopes to request for the token
   ...
   *
   * @param {Array.<string>} [scopes] - Array of scopes which are mandatory for the token
  ...
  exchangeToken(accessToken) {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (!that._credentials) {
        return reject(new Error('SAP IoT service binding missing'));
      }
