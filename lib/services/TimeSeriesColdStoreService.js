...
class TimeSeriesColdStoreService {
  /**
     ...
     */
  static createColdStoreTimeSeriesData(thingId, thingTypeName, propertySetId, payload, { headers = {}, resolveWithFullResponse, jwt } = {}) {
  ...
  /**
     ...
     */
  static getColdStoreTimeSeriesData(thingId, thingTypeName, propertySetId, fromTime, toTime, queryParameters = {}, { headers = {}, resolveWithFullResponse, jwt } = {}) {
  ...
  /**
     ...
     */
  static deleteColdStoreTimeSeriesData(thingId, thingTypeName, propertySetId, fromTime, toTime, { headers = {}, resolveWithFullResponse, jwt } = {}) {
