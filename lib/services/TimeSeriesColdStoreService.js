...
class TimeSeriesColdStoreService {
  /**
     ...
     */
  static createColdStoreTimeSeriesData(thingId, thingTypeName, propertySetId, payload, { headers = {}, resolveWithFullResponse, jwt, scopes } = {}) {
  ...
  /**
     ...
     */
  static getColdStoreTimeSeriesData(thingId, thingTypeName, propertySetId, fromTime, toTime, queryParameters = {}, { headers = {}, resolveWithFullResponse, jwt, scopes } = {}) {
    const enhancedQueryParameters = queryParameters;
    enhancedQueryParameters.timerange = `${fromTime}-${toTime}`;
    return this.request({
      url: `${this.navigator.appiotColdstore()}/Things('${thingId}')/${thingTypeName}/${propertySetId}?${querystring.stringify(enhancedQueryParameters)}`,
      headers,
      resolveWithFullResponse,
      jwt,
      scopes
  ...
  /**
     ...
     */
  static deleteColdStoreTimeSeriesData(thingId, thingTypeName, propertySetId, fromTime, toTime, { headers = {}, resolveWithFullResponse, jwt, scopes } = {}) {
