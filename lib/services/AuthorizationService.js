...
class AuthorizationService {
     ...
     */
    static createObjectGroup(payload, { headers = {}, resolveWithFullResponse, jwt, scopes } = {}) {
        return this.request({
     ...
     */
    static getObjectGroup(objectGroupId, { headers = {}, resolveWithFullResponse, jwt, scopes } = {}) {
        return this.request({
     ...
     */
    static getObjectGroups(queryParameters = {}, { headers = {}, resolveWithFullResponse, jwt, scopes } = {}) {
     ...
     */
    static getRootObjectGroup({ headers = {}, resolveWithFullResponse, jwt, scopes } = {}) {
        return this.request({
     ...
     */
    static deleteObjectGroup(objectGroupId, etag, { headers = {}, resolveWithFullResponse, jwt, scopes } = {}) {
