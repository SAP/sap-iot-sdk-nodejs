...
class AuthorizationService {
     ...
     */
    static createObjectGroup(payload, { headers = {}, resolveWithFullResponse, jwt } = {}) {
        return this.request({
     ...
     */
    static getObjectGroup(objectGroupId, { headers = {}, resolveWithFullResponse, jwt } = {}) {
        return this.request({
     ...
     */
    static getObjectGroups(queryParameters = {}, { headers = {}, resolveWithFullResponse, jwt } = {}) {
        const queryString = querystring.stringify(queryParameters);
        const urlQueryString = queryString ? `?${queryString}` : '';
        return this.request({
            url: `${this.navigator.authorization()}/ObjectGroups${urlQueryString}`,
            headers,
            resolveWithFullResponse,
            jwt
        });
     ...
     */
    static getRootObjectGroup({ headers = {}, resolveWithFullResponse, jwt } = {}) {
        return this.request({
     ...
     */
    static deleteObjectGroup(objectGroupId, etag, { headers = {}, resolveWithFullResponse, jwt } = {}) {
