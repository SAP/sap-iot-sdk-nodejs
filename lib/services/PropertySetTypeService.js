 ...
 * @property {string} [scopes] - Array of scopes requested within token for this request
 */
...
class PropertySetTypeService {
  ...
  static getPropertySetType(propertySetTypeName, queryParameters = {}, {
    ...
    const path = `/ThingConfiguration/v1/PropertySetTypes('${propertySetTypeName}')${query}`;
    return this.request({
      url: `${this.navigator.configThing()}${path}`,
      headers,
      resolveWithFullResponse,
      jwt,
      scopes,
  ...
  static getPropertySetTypes(queryParameters = {}, {
    ...
    const queryString = querystring.stringify(queryParameters);
    const path = `/ThingConfiguration/v1/PropertySetTypes${queryString ? `?${queryString}` : ''}`;
    return this.request({
      url: `${this.navigator.configThing()}${path}`,
      headers,
      resolveWithFullResponse,
  ...
  static getPropertySetTypesByPackage(packageName, queryParameters = {}, {
    ...
    const queryString = querystring.stringify(queryParameters);
    const query = `${queryString ? `?${queryString}` : ''}`;
    const path = `/ThingConfiguration/v1/Packages('${packageName}')/PropertySetTypes${query}`;
    return this.request({
      url: `${this.navigator.configThing()}${path}`,
      headers,
      resolveWithFullResponse,
