...
class PropertySetTypeService {
     ...
     */
    static createPropertySetType(packageName, payload, { headers = {}, resolveWithFullResponse = false, jwt, scopes } = {}) {
        return this.request({
     ...
     */
    static getPropertySetType(propertySetTypeName, queryParameters = {}, { headers = {}, resolveWithFullResponse = false, jwt, scopes } = {}) {
     ...
     */
    static getPropertySetTypes(queryParameters = {}, { headers = {}, resolveWithFullResponse = false, jwt, scopes } = {}) {
        const queryString = querystring.stringify(queryParameters);
        return this.request({
     ...
     */
    static getPropertySetTypesByPackage(packageName, queryParameters = {}, { headers = {}, resolveWithFullResponse = false, jwt, scopes } = {}) {
        const queryString = querystring.stringify(queryParameters);
        return this.request({
     ...
     */
    static deletePropertySetType(propertySetTypeName, etag, { headers = {}, resolveWithFullResponse, jwt, scopes } = {}) {
