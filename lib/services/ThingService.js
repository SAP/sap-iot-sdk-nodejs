...
class ThingService {
  /**
     ...
     */
  static createThing(payload, { headers = {}, resolveWithFullResponse, jwt } = {}) {
    return this.request({
  ...
  /**
     ...
     */
  static getThing(thingId, { headers = {}, resolveWithFullResponse, jwt } = {}) {
    return this.request({
  ...
  /**
     ...
     */
  static getThingByAlternateId(alternateId, { headers = {}, resolveWithFullResponse, jwt } = {}) {
    return this.request({
  ...
  /**
     ...
     */
  static getThings(queryParameters = {}, { headers = {}, resolveWithFullResponse, jwt } = {}) {
    const queryString = querystring.stringify(queryParameters);
    const urlQueryString = queryString ? `?${queryString}` : '';
    const url = `${this.navigator.appiotMds()}/Things${urlQueryString}`;
    return this.request({
      url,
      headers,
      resolveWithFullResponse,
  ...
  /**
     ...
     * @see <a href="https://help.sap.com/viewer/080fabc6cae6423fb45fca7752adb61e/latest/en-US/075566a948d54a9e822f21fea493df8e.html">SAP Help API documentation</a>
     */
  static getThingsByThingType(thingTypeName, queryParameters = {}, { headers = {}, resolveWithFullResponse, jwt } = {}) {
    ...
    return this.getThings(queryParameters, { headers, resolveWithFullResponse, jwt });
  }
  ...
  /**
     ...
     */
  static deleteThing(thingId, { headers = {}, resolveWithFullResponse, jwt } = {}) {
    return this.request({
      url: `${this.navigator.appiotMds()}/Things('${thingId}')`,
      method: 'DELETE',
      headers,
