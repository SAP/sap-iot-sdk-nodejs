...
class ThingService {
  ...
  /**
     ...
     * @see <a href="https://help.sap.com/viewer/080fabc6cae6423fb45fca7752adb61e/latest/en-US/075566a948d54a9e822f21fea493df8e.html">SAP Help API documentation</a>
     */
  static async getThingsByThingType(thingTypeName, queryParameters = {}, { headers = {}, resolveWithFullResponse, jwt } = {}) {
    if (queryParameters.$filter) {
      queryParameters.$filter += ` and _thingType eq '${thingTypeName}'`;
    } else {
      queryParameters.$filter = `_thingType eq '${thingTypeName}'`;
    }
  ...
  /**
     ...
     * @param {RequestConfig} [requestConfig] - configuration of request metadata parameters
     * @returns {Promise.<*>} - API response
     * @see <a href="https://help.sap.com/viewer/080fabc6cae6423fb45fca7752adb61e/1905b/en-US/5902f2914b7548c89d74cc21e7b2fd45.html">SAP Help API documentation</a>
     */
