...
class TimeSeriesStoreService {
  /**
     ...
     */
  static createTimeSeriesData(thingId, thingTypeName, propertySetId, payload, { headers = {}, resolveWithFullResponse, jwt } = {}) {
  ...
  /**
     ...
     */
  static getTimeSeriesData(thingId, thingTypeName, propertySetId, queryParameters = {}, { headers = {}, resolveWithFullResponse, jwt } = {}) {
    const queryString = querystring.stringify(queryParameters);
    const urlQueryString = queryString ? `?${queryString}` : '';
    return this.request({
      url: `${this.navigator.appiotMds()}/Things('${thingId}')/${thingTypeName}/${propertySetId}${urlQueryString}`,
      headers,
      resolveWithFullResponse,
      jwt
    });
  ...
  /**
     ...
     * @param {RequestConfig} [requestConfig] - configuration of request metadata parameters
     * @returns {Promise.<*>} API response
     * @see <a href="https://help.sap.com/viewer/080fabc6cae6423fb45fca7752adb61e/latest/en-US/650d94e61d7c487e9f16052938dabba9.html">SAP Help API documentation</a>
     */
  static getThingSnapshot(thingId, dataCategory = '', { headers = {}, resolveWithFullResponse, jwt } = {}) {
    return this.request({
  ...
  /**
     ...
     */
  static deleteTimeSeriesData(thingId, thingTypeName, propertySetId, fromTime, toTime, { headers = {}, resolveWithFullResponse, jwt } = {}) {
