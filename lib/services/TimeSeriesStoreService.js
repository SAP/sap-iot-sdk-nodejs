...
class TimeSeriesStoreService {
  /**
     ...
     */
  static createTimeSeriesData(thingId, thingTypeName, propertySetId, payload, { headers = {}, resolveWithFullResponse, jwt, scopes } = {}) {
  ...
  /**
     ...
     */
  static getTimeSeriesData(thingId, thingTypeName, propertySetId, queryParameters = {}, { headers = {}, resolveWithFullResponse, jwt, scopes } = {}) {
  ...
  /**
     ...
     */
  static deleteTimeSeriesData(thingId, thingTypeName, propertySetId, fromTime, toTime, { headers = {}, resolveWithFullResponse, jwt, scopes } = {}) {
