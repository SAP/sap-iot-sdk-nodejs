...
class EventService {
  /**
     ...
     */
  static createEvent(payload, { headers = {}, resolveWithFullResponse, jwt } = {}) {
    return this.request({
  ...
  /**
     ...
     */
  static getEvent(eventId, { headers = {}, resolveWithFullResponse, jwt } = {}) {
    return this.request({
  ...
  /**
     ...
     */
  static getEvents(queryParameters = {}, { headers = {}, resolveWithFullResponse, jwt } = {}) {
    const queryString = querystring.stringify(queryParameters);
    const urlQueryString = queryString ? `?${queryString}` : '';
    const url = `${this.navigator.appiotMds()}/Events${urlQueryString}`;
    return this.request({
      url,
      headers,
      resolveWithFullResponse,
  ...
  /**
     ...
     * @see <a href="https://help.sap.com/viewer/080fabc6cae6423fb45fca7752adb61e/latest/en-US/bd98624f54da496ca58ccd8d8262ad44.html">SAP Help API documentation</a>
     */
  static getEventsByThingId(thingId, queryParameters = {}, { headers = {}, resolveWithFullResponse, jwt } = {}) {
    ...
    return this.getEvents(enhancedQueryParameters, { headers, resolveWithFullResponse, jwt });
  }
  ...
  /**
     ...
     */
  static deleteEvent(eventId, { headers = {}, resolveWithFullResponse, jwt } = {}) {
    return this.request({
      url: `${this.navigator.appiotMds()}/Events('${eventId}')`,
      method: 'DELETE',
      headers,
