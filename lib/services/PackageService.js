...
class PackageService {
     ...
     */
    static createPackage(payload, { headers = {}, resolveWithFullResponse = false, jwt, scopes } = {}) {
        return this.request({
     ...
     */
    static getPackage(packageName, { headers = {}, resolveWithFullResponse = false, jwt, scopes } = {}) {
        return this.request({
     ...
     */
    static getPackages(queryParameters = {}, { headers = {}, resolveWithFullResponse = false, jwt, scopes } = {}) {
     ...
     */
    static deletePackage(packageName, etag, { headers = {}, resolveWithFullResponse, jwt, scopes } = {}) {
