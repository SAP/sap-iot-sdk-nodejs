...
class PackageService {
     ...
     */
    static createPackage(payload, { headers = {}, resolveWithFullResponse = false, jwt } = {}) {
        return this.request({
     ...
     */
    static getPackage(packageName, { headers = {}, resolveWithFullResponse = false, jwt } = {}) {
        return this.request({
     ...
     */
    static getPackages(queryParameters = {}, { headers = {}, resolveWithFullResponse = false, jwt } = {}) {
        const queryString = querystring.stringify(queryParameters);
        const urlQueryString = queryString ? `?${queryString}` : '';
        const url = `${this.navigator.configPackage()}/Package/v1/Packages${urlQueryString}`;
        return this.request({
            url,
            headers,
            resolveWithFullResponse,
     ...
     */
    static deletePackage(packageName, etag, { headers = {}, resolveWithFullResponse, jwt } = {}) {
