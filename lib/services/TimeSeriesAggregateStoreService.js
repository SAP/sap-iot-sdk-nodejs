...
class TimeSeriesAggregateStoreService {
  ...
  /**
     ...
     */
  static getThingSnapshotWithinTimeRange(thingId, fromTime, toTime, dataCategory = '', { headers = {}, resolveWithFullResponse, jwt } = {}) {
    return this.request({
   ...
   */
  static async recalculateAggregates(thingId, thingTypeName, propertySetId, fromTime, toTime, { headers = {}, resolveWithFullResponse, jwt } = {}) {
