...
class ThingTypeService {
     ...
     */
    static createThingType(packageName, payload, { headers = {}, resolveWithFullResponse = false, jwt } = {}) {
        return this.request({
     ...
     */
    static getThingType(thingTypeName, queryParameters = {}, { headers = {}, resolveWithFullResponse = false, jwt } = {}) {
        const queryString = querystring.stringify(queryParameters);
        const urlQueryString = queryString ? `?${queryString}` : '';
        return this.request({
            url: `${this.navigator.configThing()}/ThingConfiguration/v1/ThingTypes('${thingTypeName}')${urlQueryString}`,
            headers,
            resolveWithFullResponse,
            jwt
        });
     ...
     */
    static getThingTypes(queryParameters = {}, { headers = {}, resolveWithFullResponse, jwt } = {}) {
        const queryString = querystring.stringify(queryParameters);
        const urlQueryString = queryString ? `?${queryString}` : '';
        return this.request({
            url: `${this.navigator.configThing()}/ThingConfiguration/v1/ThingTypes${urlQueryString}`,
            headers,
            resolveWithFullResponse,
            jwt
        });
     ...
     */
    static getThingTypesByPackage(packageName, queryParameters = {}, { headers = {}, resolveWithFullResponse, jwt } = {}) {
        const queryString = querystring.stringify(queryParameters);
        const urlQueryString = queryString ? `?${queryString}` : '';
        return this.request({
            url: `${this.navigator.configThing()}/ThingConfiguration/v1/Packages('${packageName}')/ThingTypes${urlQueryString}`,
            headers,
            resolveWithFullResponse,
            jwt
        });
     ...
     */
    static deleteThingType(thingTypeName, etag, { headers = {}, resolveWithFullResponse, jwt } = {}) {
