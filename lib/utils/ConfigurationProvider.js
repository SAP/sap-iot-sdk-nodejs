...
class ConfigurationProvider {
     ...
     * 2) Fetch credentials from service binding of Leonardo IoT service
     ...
     * 1) Fetch landscape information from service binding of Leonardo IoT service
     ...
     * This method returns a key value map where key equals the service name (i.e. appiot-mds) and value equals the full destination URI
     * (i.e. https://appiot-mds.cfapps.eu10.hana.ondemand.com)
     * @param {String} [serviceName] - name of service which is providing tenant information
     * @returns {*}
     */
